#!/usr/bin/env python3
"""Run cumulative P4–P8 (or any rung) against local Transformers MiniCPM5-2B."""
...
def main() -> int:
    ...
    parser.add_argument("--rung", type=int, default=8)
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "results" / "runs" / "p8_real_minicpm5_mini_v1.json")
